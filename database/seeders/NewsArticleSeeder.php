...
class NewsArticleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        NewsArticle::create([
            ...
            'content' => $longContent,
            'image_url' => 'news-3.jpg',
            'gallery_images' => ['news-1.jpg', 'news-2.jpg', 'news-3.jpg', 'team-1.jpg'],
        ...
        NewsArticle::create([
            ...
            'gallery_images' => ['team-1.jpg', 'team-2.png', 'team-3.jpg', 'news-1.jpg', 'news-2.jpg'],
            'video_url' => null,
        ...
        for ($i = 4; $i <= 15; $i++) {
            ...
            NewsArticle::create([
                ...
                'content' => $longContent,
                'image_url' => $i % 2 === 0 ? 'news-bg-1.png' : 'news-bg-2.png',
                'gallery_images' => $hasGallery ? ['news-1.jpg', 'news-2.jpg'] : null,
