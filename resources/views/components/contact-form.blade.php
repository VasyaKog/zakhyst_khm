    ...
    <form id="contact-form" class="space-y-8" method="POST" action="{{ route('contact.submit') }}">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="relative">
                <input type="text" id="first_name" name="first_name" data-placeholder="[ ІМ'Я* ]"
                    class="w-full h-[60px] lg:h-[70px] bg-transparent text-[20px] lg:text-[24px] font-bold font-['Montserrat'] text-black appearance-none focus:ring-0 focus:shadow-none border-0 border-b-2 border-[#BEBEBE] outline-none pt-[18px] lg:pt-[22px] pl-[20px] lg:pl-[25px]"
                    required>
                <span
                    class="absolute left-[20px] lg:left-[25px] top-[18px] lg:top-[22px] text-[20px] lg:text-[24px] font-bold font-['Montserrat'] text-black uppercase pointer-events-none"
        ...
        <div class="relative">
            <textarea id="message" name="message" data-placeholder="[ Твій запит* ]"
                class="w-full h-[300px] lg:h-[458px] bg-transparent text-[20px] lg:text-2xl font-normal font-['Montserrat'] text-black leading-10 appearance-none focus:ring-0 focus:shadow-none border-0 border-b-2 border-[#BEBEBE] outline-none resize-none pt-[18px] lg:pt-[22px] pl-[20px] lg:pl-[25px]"
                required></textarea>
            <span
                class="absolute left-[20px] lg:left-[25px] top-[18px] lg:top-[22px] text-[20px] lg:text-[24px] font-bold font-['Montserrat'] text-black uppercase pointer-events-none"
