<!-- Toast Notification -->
<div id="contact-toast" class="fixed bottom-8 left-1/2 -translate-x-1/2 bg-veteran-blue text-white px-6 py-3 rounded-lg shadow-lg z-[60] opacity-0 transition-opacity duration-300 pointer-events-none">
...
<div id="contact-modal" class="fixed inset-0 bg-black bg-opacity-50 z-50 hidden items-center justify-center p-4">
    <div class="bg-white w-[776px] h-[832px] relative overflow-hidden">
        <!-- Close Button -->
        <button id="close-contact-modal" class="absolute top-6 right-6 z-10 w-8 h-8 flex items-center justify-center text-black hover:text-veteran-blue transition-colors">
        ...
        <!-- Modal Content -->
        <div class="pt-[80px] px-[70px] h-full">
            <form id="contact-form" class="h-full flex flex-col space-y-6">
                ...
                <div class="flex space-x-8">
                    ...
                    <div class="flex-1 relative">
                        <input 
                            ...
                            name="name" 
                            required
                            class="w-full h-12 bg-transparent text-xl font-bold font-['Montserrat'] leading-relaxed text-black appearance-none focus:ring-0 focus:shadow-none"
                ...
                <div class="relative pt-[30px]">
                    <input 
                        ...
                        name="contact" 
                        required
                        class="w-full h-12 bg-transparent text-xl font-bold font-['Montserrat'] uppercase leading-relaxed text-black appearance-none focus:ring-0 focus:shadow-none"
                        style="border: none; border-bottom: 1px solid #9CA3AF; outline: none; box-shadow: none;"
                ...
                <!-- Message Field -->
                <div class="flex-1 relative pt-[60px]">
                    <textarea 
                        id="contact-message" 
                        name="message" 
                        required
                        class="w-full h-[345px] bg-transparent text-xl font-bold font-['Montserrat'] uppercase leading-relaxed text-black appearance-none focus:ring-0 focus:shadow-none"
                        style="border: none; border-bottom: 1px solid #9CA3AF; outline: none; resize: none; box-shadow: none;"
                        placeholder="[ Твій запит / відгук* ]"
                    ></textarea>
                </div>
...
#contact-name:focus, #contact-surname:focus, #contact-contact:focus, #contact-message:focus {
    outline: none !important;
    box-shadow: none !important;
}
#contact-name:focus { border-bottom-color: #3971E2; }
#contact-surname:focus { border-bottom-color: #3971E2; }
#contact-contact:focus { border-bottom-color: #3971E2; }
#contact-message:focus { border-bottom-color: #3971E2; }
</style>
