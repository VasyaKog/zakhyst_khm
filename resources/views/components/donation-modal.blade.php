...
<div id="donation-modal" class="fixed inset-0 bg-black bg-opacity-50 z-[70] hidden items-center justify-center p-4">
    <div
        ...
        <div class="pt-12 md:pt-[70px] px-6 md:px-[70px]">
            <div class="pb-4 pl-4 md:pl-[25px] border-b-4 border-veteran-blue">
                <div class="text-lg md:text-2xl font-bold font-montserrat text-black dark:text-white transition-colors">
                    {{ __('Privat Bank') }}
                </div>
            </div>
        </div>
