...
@section('content')
    <div class="bg-white">
        ...
        <div class="pt-[40px] lg:pt-[120px] pb-[60px] lg:pb-[100px] overflow-hidden">
            ...
            <!-- Page Title -->
            <div class="px-4 lg:px-0 lg:max-w-[1200px] lg:mx-auto mb-[40px] lg:mb-[80px]">
                <h1
        ...
        <div class="lg:flex lg:justify-center mb-[80px] lg:mb-[150px] px-4 lg:px-0">
            <div class="relative w-full lg:w-[1170px]">
                <!-- Connecting Line -->
                <div class="absolute left-[19px] lg:left-[20px] top-[20px] lg:top-[71px] bottom-[50px] lg:bottom-[100px] w-[2px] bg-[#3971E2] z-0"></div>
