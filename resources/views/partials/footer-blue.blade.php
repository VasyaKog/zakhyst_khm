<footer
    class="flex flex-wrap min-[1250px]:flex-nowrap items-center justify-center min-[1250px]:justify-between mt-[40px] mb-[50px] px-5 min-[1250px]:px-[2.6%] gap-10 min-[1250px]:gap-0 bg-veteran-blue">
    <!-- Organization Logo and Name -->
    <img src="{{ asset('images/logos/logo-text.svg') }}" alt="Logo"
        class="brightness-0 invert flex-shrink-0 mb-6 min-[1250px]:mb-0">
    ...
    <div
        ...
        <img src="{{ asset('images/icons/facebook.svg') }}" alt="Facebook" class="w-6 h-6 mr-5 brightness-0 invert">
        <img src="{{ asset('images/icons/instagram.svg') }}" alt="Instagram" class="w-6 h-6 brightness-0 invert">
    </div>
    ...
    <div
        ...
        <div class="text-white text-base font-bold mr-0 min-[1250px]:mr-[80px]">
    ...
    <div
        ...
        <div
            class="text-white text-base font-bold min-[1250px]:mb-5 text-center min-[1250px]:text-right w-full sm:w-auto">
            veteranskiprostirkhm.gmail.com
        </div>
        <div class="flex items-center justify-center w-full sm:w-auto">
            <img src="{{ asset('images/icons/watsapnp.svg') }}" alt="WhatsApp" class="w-6 h-6 mr-2 brightness-0 invert">
            ...
            <span class="text-white text-base font-bold">+38 067 563 0090</span>
        </div>
    </div>
</footer>