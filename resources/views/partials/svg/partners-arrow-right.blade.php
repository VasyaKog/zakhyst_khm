<svg width="43" height="44" viewBox="0 0 43 44" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full transform scale-x-[-1]">
    <g opacity="0.5" clip-path="url(#clip0_598_10481_right)">
    ...
    <defs>
        <clipPath id="clip0_598_10481_right">
